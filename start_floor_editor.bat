...
set LOGFILE=%~dp0logs\server-floor-editor.log
call :pick_port
if errorlevel 1 goto :port_failed
start "Isometric Floor Editor Server" /min cmd /c ""%~dp0server\run_server.bat" %PORT% editor"
call :wait_ready
if errorlevel 1 goto :server_failed
start "" "http://127.0.0.1:%PORT%/START_FLOOR_EDITOR.html?v=20260410-floor-editor-v1"
exit /b
...
echo Open logs\server-floor-editor.log in the project folder to see the actual error.
