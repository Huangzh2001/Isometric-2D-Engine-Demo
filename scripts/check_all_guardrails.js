...
const guardrails = [
  ...
  'scripts/check_static_world_face_descriptor_builder_boundary.js',
  'scripts/check_static_world_packet_ordering_boundary.js',
  'scripts/check_render_cache_boundary.js',
  'scripts/check_frame_assembler_boundary.js',
  'scripts/check_render_order_boundary.js',
  'scripts/check_renderable_order_adapter_boundary.js',
  ...
  'scripts/check_terrain_renderable_builder_boundary.js',
  'scripts/check_render_frame_plan_boundary.js',
  'scripts/check_sprite_renderer_boundaries.js',
  'scripts/check_placement_preview_debug_overlay_boundaries.js',
  'scripts/check_render_dead_code_pruning.js',
  'scripts/check_instance_renderable_builder_boundary.js',
  'scripts/check_render_scope_builder_boundary.js',
  'scripts/check_static_renderable_facade_boundary.js',
  ...
  'scripts/check_render_diagnostics_facade_boundary.js',
  'scripts/check_actor_interaction_order_diagnostics_boundary.js',
  'scripts/check_actor_interaction_geometry_boundary.js',
  'scripts/check_actor_interaction_replacement_boundary.js',
  'scripts/check_stable_local_demerge_boundary.js',
  'scripts/check_actor_support_top_sort_override_boundary.js',
