CURRENT PHASE: P3-C + P4-D render ordering + support domainization

# AGENTS.md

> **修改本项目之前，先阅读根目录 `000_READ_THIS_FIRST_FOR_AI.md` 与 `001_SOURCE_OF_TRUTH.md`。**
>
> 该文件给出当前确定的 10-phase 重构主线与四层最终目标；本文件负责补充工程约束。
...
根目录 `app.js / state.js / app-shell.js / lighting-editor.js` 只是废弃 stub，**禁止编辑**。
...
- Current working step: **P3-C** (state write-path consolidation for runtime + prefab + scene graph entry points)
- New source files to inspect first: `src/core/state/state-owner-map.js`, `docs/STATE_INVENTORY.zh-CN.md`, `docs/STATE_OWNER_MAP.zh-CN.md`
